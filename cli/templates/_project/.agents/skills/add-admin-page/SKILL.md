...
The page works at narrow and wide widths, keyboard focus is visible, every data state is handled, copy names the outcome, and `pnpm check:admin && pnpm build:admin` pass.
