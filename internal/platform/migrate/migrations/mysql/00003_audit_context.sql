...
ALTER TABLE audit_logs
    ...
    ADD COLUMN sanitized_before JSON NOT NULL DEFAULT (JSON_OBJECT()),
    ADD COLUMN sanitized_after JSON NOT NULL DEFAULT (JSON_OBJECT());
...
DROP INDEX idx_audit_logs_resource ON audit_logs;
DROP INDEX idx_audit_logs_actor ON audit_logs;
