	...
	return []module.Module{
		staticModule{
			...
			permissions: []module.PermissionDefinition{
				...
				{Code: "roles:read", Description: "View roles and permissions"},
			...
			operations: []module.OperationDefinition{
				...
				rateLimited(protectedOperation("listPermissions", module.MethodGet, "/api/v1/permissions", "roles:read", policySystem), sensitiveRateLimit),
...
func builtInAuthorizationMode(
	...
	case "createUploadIntent", "localUpload", "localContent",
		"confirmUpload", "getFileURL", "deleteFile":
